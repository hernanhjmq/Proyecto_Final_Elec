...
<html lang="en">
    ...
    <body>
        ...
        <h1 style="text-align-last: center"> NUEVOS REGISTROS PARA LAS ENTRADAS DE PRODDUCTOS </h1>
 
        <form  style="padding:  50px ; background-color: darkgrey;" method="post" action="EntradaControlador" >
            ...
            <div class="mb-3">
                ...
                <select name="id_proveedor" class="form-control">
                    ...
                    <c:forEach var="item" items="${formu3}">
                        <option value="${item.id}" <c:if test="${formu.id_proveedor == item.id}">
                                    selected
                                </c:if>>
                            ${item.nombre}
                        </option>
